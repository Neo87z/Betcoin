              ...
              <div style={{ width: '250%' }} className="max-w-xl md:max-w-none border-t border-gray-800 md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up" data-aos-anchor="[data-aos-id-features-home]">
                ...
                <div className="relative">
                  <div   className="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
                   ...
                   <center> <h2 style={{ marginTop: '70px',marginLeft:'-27%' }} className="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-tabs]">Live Chat</h2></center>
                ...
                <div style={{ width:'60%', height: '340px', overflow: 'auto', margin: '20px', textAlign: 'justify', padding: '20px' }}>
                        ...
                        <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-anchor="[data-aos-id-timeline]">
                          <div className="pl-2">
                            ...
                            <div className="flex items-center mb-3">
                              <div style={{marginLeft:'-20px'}}className="absolute left-0 inline-flex text-sm font-semibold py-1 px-3 text-green-600 bg-green-200 rounded-full">{val.Sender}</div>
